...
export type GetHistoriesQuery = {
  histories?: Array<{
    ...
    links?: { article?: string | null; wikipedia?: string | null } | null
  } | null> | null
}
...
export function useGetHistoryQuery(
  variables:
    ...
    | VueCompositionApi.Ref<GetHistoryQueryVariables>
    | ReactiveFunction<GetHistoryQueryVariables>,
  options:
    | VueApolloComposable.UseQueryOptions<
        GetHistoryQuery,
        GetHistoryQueryVariables
  ...
  return VueApolloComposable.useQuery<
    GetHistoryQuery,
    GetHistoryQueryVariables
  >(GetHistoryDocument, variables, options)
}
...
export type GetHistoryQueryCompositionFunctionResult =
  VueApolloComposable.UseQueryReturn<GetHistoryQuery, GetHistoryQueryVariables>
