...
export type GetHistoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHistoriesQuery = { histories?: Array<{ id?: string | null, title?: string | null, details?: string | null, event_date_unix?: any | null, links?: { article?: string | null, wikipedia?: string | null } | null } | null> | null };
...
export type GetHistoryQuery = { history?: { id?: string | null, title?: string | null, details?: string | null, event_date_unix?: any | null, links?: { article?: string | null, wikipedia?: string | null } | null } | null };
 ...
 */
export function useGetHistoriesQuery(options: VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetHistoriesQuery, GetHistoriesQueryVariables>(GetHistoriesDocument, {}, options);
}
export function useGetHistoriesLazyQuery(options: VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetHistoriesQuery, GetHistoriesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetHistoriesQuery, GetHistoriesQueryVariables>(GetHistoriesDocument, {}, options);
}
export type GetHistoriesQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<GetHistoriesQuery, GetHistoriesQueryVariables>;
 ...
 * });
 */
export function useGetHistoryQuery(variables: GetHistoryQueryVariables | VueCompositionApi.Ref<GetHistoryQueryVariables> | ReactiveFunction<GetHistoryQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GetHistoryQuery, GetHistoryQueryVariables>(GetHistoryDocument, variables, options);
}
export function useGetHistoryLazyQuery(variables: GetHistoryQueryVariables | VueCompositionApi.Ref<GetHistoryQueryVariables> | ReactiveFunction<GetHistoryQueryVariables>, options: VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GetHistoryQuery, GetHistoryQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GetHistoryQuery, GetHistoryQueryVariables>(GetHistoryDocument, variables, options);
}
export type GetHistoryQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<GetHistoryQuery, GetHistoryQueryVariables>;